...
const Uploads = ({isOpen,setIsOpen}:{isOpen:boolean, setIsOpen:Dispatch<SetStateAction<boolean>>}) => {
        ...
        <div> 
            <AlertDialog open={isOpen}>
                <AlertDialogContent className='p-8 '>
                    <Link href={'/'} className='fixed top-4 cursor-pointer right-6' onClick={() => setIsOpen(false)}>&#x2715;</Link>
